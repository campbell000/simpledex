...
+ (id) createPokemonDatabase2: (NSString*)filename
{
    ...
    for(int i = 1; i < [array count]; i++)
    {
        ...
        NSImage* pokemonIcon =  [database getPokemonIcon:num];
...
{
    NSLog(@"Tryna get type for num %d", pokemonID);
